namespace DosCommand
{
	...
	public partial class LauncherCore
	{
		...
		public IVersionLocator _versionLocator;
		...
		{
			LaunchInternal(options, argumentsOperators);
			return null;
		}
	...
	public class LauncherCoreCreationOption
	{
		...
		[Obsolete]
		public static LauncherCoreCreationOption Create(string gameRootPath = null,IVersionLocator versionLocator = null)
		{
			return new LauncherCoreCreationOption(gameRootPath,versionLocator);
		}
	}
